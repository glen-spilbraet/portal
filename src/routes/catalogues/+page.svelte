						...
						<div class="card">
							...
							<div class="card-footer">
								...
								{#if !isSharedView}
									...
									<a class="stats-btn" class:stats-active={cat.session_count > 0} style="margin-left:auto" href="/catalogues/{cat.id}/analytics" onclick={(e) => e.stopPropagation()} title="View analytics">
