...
<style>
	...
	.flag { margin-left: 8px; display: inline-flex; line-height: 0; border-radius: 2px; overflow: hidden; box-shadow: 0 0 0 1px rgba(0,0,0,0.10); vertical-align: middle; }
	.flag :global(svg) { width: 19px; height: 13px; display: block; }
